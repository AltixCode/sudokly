...
`apps.json`). Fix it there and re-run `node scripts/bootstrap.mjs sudokly`,
...
| | |
|---|---|
| Bundle id / package | `com.altixcode.sudokly` |
| Scheme | `sudokly://` |
| RevenueCat entitlement | `remove_ads` |
| RevenueCat package | `$rc_lifetime` |
| iOS product | `com.altixcode.sudokly.removeads` |
| Android product | `remove_ads` |
| GitHub | `AltixCode/sudokly` |
