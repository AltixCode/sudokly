...
/**
 * Store identity and native configuration for Sudokly.
 *
...
const TRACKING_USAGE =
  'This lets us show you ads that are more relevant to you. Your data is never sold, and Sudokly works exactly the same either way.';
...
const config: ExpoConfig = {
  ...
  assetBundlePatterns: ['**/*'],
  ios: {
    bundleIdentifier: 'com.altixcode.sudokly',
    buildNumber: BUILD,
    supportsTablet: true,
